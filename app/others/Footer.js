  ...
  return (
    <View>
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => navigateToScreen('matches')}>
        ...
        <TouchableOpacity style={styles.navItem} onPress={() => navigateToScreen('social')}>
          <Icon name="users" size={24} color={colors.primary} />
          <Text style={styles.navText}>Social</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem} onPress={() => navigateToScreen('mydata')}>
