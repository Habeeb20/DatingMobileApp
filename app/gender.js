      ...
      <View style={styles.gradient}>
        <View style={styles.content}>
          ...
          <View style={styles.genderOptions}>
            ...
            >
              <Text style={[styles.genderText, selectedGender === 'female' && styles.selectedText]}>Woman</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.genderButton, selectedGender === 'male' && styles.selectedButton]}
              onPress={() => setSelectedGender('male')}
            >
              <Text style={[styles.genderText, selectedGender === 'male' && styles.selectedText]}>Man</Text>
            </TouchableOpacity>
          </View>
          <TouchableOpacity
